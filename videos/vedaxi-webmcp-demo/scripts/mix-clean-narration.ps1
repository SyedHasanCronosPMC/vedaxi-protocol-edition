...
$output = Join-Path $root 'renders\vedaxi-webmcp-demo-2m20s-clean-narration-v2.mp4'
...
ffmpeg -hide_banner -loglevel error -y `
  ...
  -filter_complex "[1:a]volume=0.7,afade=t=in:st=0:d=2,afade=t=out:st=136:d=4[bed];[2:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=0|0[n1];[3:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=12000|12000[n2];[4:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=30000|30000[n3];[5:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=48000|48000[n4];[6:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=63000|63000[n5];[7:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=80000|80000[n6];[8:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=99000|99000[n7];[9:a]highpass=f=80,equalizer=f=3000:t=q:w=1:g=2.5,acompressor=threshold=0.08:ratio=2.5:attack=10:release=150:makeup=2,alimiter=limit=0.89,adelay=118000|118000[n8];[10:a]volume=0.62,adelay=4000|4000[impact];[11:a]volume=0.34,adelay=9000|9000[riser];[12:a]volume=0.32,adelay=62000|62000[whoosh];[13:a]volume=0.85,adelay=99000|99000[click];[14:a]volume=0.8,adelay=136000|136000[chime];[bed][n1][n2][n3][n4][n5][n6][n7][n8][impact][riser][whoosh][click][chime]amix=inputs=14:normalize=0:dropout_transition=0,alimiter=limit=0.94[a]" `
